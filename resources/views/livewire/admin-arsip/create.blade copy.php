...
# Buat view untuk Edit
cat > resources/views/livewire/admin-arsip/edit.blade.php << 'EOF'
<div>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6">
                        <h2 class="text-2xl font-semibold text-gray-800">Edit Arsip (Admin)</h2>
                        <p class="mt-1 text-sm text-gray-600">Mengedit arsip: {{ $arsip->judul }}</p>
                    </div>
                    ...
                    <form wire:submit.prevent="update">
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div class="mt-1 p-3 bg-gray-50 rounded-md">
                                    @if($arsip->file)
                                        <div class="flex items-center justify-between">
                                            <div>
                                                <p class="text-sm text-gray-900">{{ basename($arsip->file) }}</p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                @if($newFile)
                                    <p class="mt-1 text-sm text-gray-500">File baru: {{ $newFile->getClientOriginalName() }} ({{ round($newFile->getSize() / 1024, 2) }} KB)</p>
                                @endif
                            </div>
                            ...
                            @if($arsip->thumbnail)
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <img src="{{ Storage::url($arsip->thumbnail) }}" alt="Thumbnail" class="h-32 w-auto rounded">
                                    </div>
                                </div>
                            @endif
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Ganti Thumbnail (Opsional)</label>
                                ...
                                @if($newThumbnail)
                                    <div class="mt-2">
                                        <img src="{{ $newThumbnail->temporaryUrl() }}" alt="Preview" class="h-32 w-auto rounded">
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="mt-8 flex justify-end space-x-3">
                            ...
                            <button type="submit" 
                                    wire:loading.attr="disabled"
                                    class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50">
                                <span wire:loading.remove>Update Arsip</span>
