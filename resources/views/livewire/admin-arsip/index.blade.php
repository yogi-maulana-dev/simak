        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select wire:model.live="selectedProdi" 
                                    ...
                                    class="w-full border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition {{ !$selectedFakultas ? 'bg-gray-100 text-gray-400' : '' }}">
                    ...
                    {{-- Table --}}
                    @if($arsips->isEmpty() && !$search && !$selectedFakultas && !$selectedProdi && !$selectedUser)
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse ($arsips as $arsip)
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="text-sm font-medium text-gray-900">{{ $arsip->user->name ?? '-' }}</div>
                                                ...
                                                <td class="px-6 py-4">
                                                    {{-- Fakultas dari dataFakultas --}}
                                                    <div class="space-y-1">
                                                        @if($arsip->dataFakultas->isNotEmpty())
                                                            @foreach($arsip->dataFakultas as $dataFakultas)
                                                                @if($dataFakultas->fakultas)
                                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                                        {{ $dataFakultas->fakultas->nama_fakultas }}
                                                                    </span>
                                                                @endif
                                                            @endforeach
                                                        @else
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        {{-- Tombol Delete --}}
                                                        <button wire:click="confirmDelete({{ $arsip->id }}, '{{ addslashes($arsip->judul) }}')"
                                            ...
                                            <tr>
                                                <td colspan="5" class="px-6 py-12 text-center">
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-500">
                                                        ...
                                                        @if($search || $selectedFakultas || $selectedProdi || $selectedUser)
                                                            <br>
                                                            <button wire:click="resetFilters" 
                        ...
                        <div class="mt-3 text-center sm:mt-5">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-4 p-4 bg-gray-50 rounded-lg">
                                    <p class="font-medium text-gray-900">{{ $deleteJudul ?? '' }}</p>
                                </div>
