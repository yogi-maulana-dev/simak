                ...
                <div class="hidden sm:flex items-center gap-1">
                    ...
                    @if (auth()->user()->isSuperAdmin())
                        <a href="{{ route('admin.folder-permissions') }}"
                           @class([
                               'flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200',
                               'bg-white/20 text-white shadow-sm' => request()->routeIs('admin.folder-permissions'),
                               'text-green-100 hover:bg-white/10 hover:text-white' => !request()->routeIs('admin.folder-permissions'),
                           ])>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('admin.users') }}"
                           @class([
                               'flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200',
                               'bg-white/20 text-white shadow-sm' => request()->routeIs('admin.users'),
                               'text-green-100 hover:bg-white/10 hover:text-white' => !request()->routeIs('admin.users'),
                           ])>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('admin.activity-logs') }}"
                           @class([
                               'flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200',
                               'bg-white/20 text-white shadow-sm' => request()->routeIs('admin.activity-logs'),
                               'text-green-100 hover:bg-white/10 hover:text-white' => !request()->routeIs('admin.activity-logs'),
                           ])>
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
