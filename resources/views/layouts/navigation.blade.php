                ...
                @auth
                    ...
                    @if($user->isSuperadmin())
                        ...
                        <a href="{{ route('admin.users.index') }}" 
                           class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50' }}">
                            <span class="flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="relative ml-4" x-data="{ dropdownOpen: false }">
                        ...
                        <div x-show="dropdownOpen" 
                            ...
                            <a href="{{ route('profile.edit') }}" class="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-muhammadiyah-50 hover:text-muhammadiyah-700 transition-colors">
            ...
            <div class="pt-2 pb-3 space-y-1">
                @auth
                    ...
                    @if($user->isSuperadmin())
                        ...
                        <a href="{{ route('admin.users.index') }}" 
                           class="block pl-3 pr-4 py-2 rounded-lg text-base font-medium {{ request()->routeIs('admin.users.*') ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-700 hover:border-l-4 hover:border-blue-300' }}">
                            Manajemen User
                        </a>
                    @endif
                @endauth
