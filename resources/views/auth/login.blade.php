        ...
        <div class="mb-6 animate-fadeIn">
            <div class="p-4 bg-gradient-to-r from-muhammadiyah-50 to-emerald-50 border-l-4 border-muhammadiyah-500 rounded-lg shadow-sm">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-muhammadiyah-800">{{ session('status') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative">
                <div class="relative">
                    <input id="email" 
                           ...
                           class="peer w-full px-4 py-3 pt-6 border-2 border-muhammadiyah-200 rounded-xl focus:border-muhammadiyah-400 focus:ring-2 focus:ring-muhammadiyah-100 focus:outline-none transition-all duration-300 @error('email') border-red-500 @enderror"
                           placeholder=" ">
                    <label for="email" 
            ...
            <div class="relative">
                <div class="relative">
                    <input id="password" 
                           ...
                           class="peer w-full px-4 py-3 pt-6 border-2 border-muhammadiyah-200 rounded-xl focus:border-muhammadiyah-400 focus:ring-2 focus:ring-muhammadiyah-100 focus:outline-none transition-all duration-300 @error('password') border-red-500 @enderror"
                           placeholder=" ">
                    <label for="password" 
                           class="absolute left-4 top-2 text-xs font-medium text-muhammadiyah-600 peer-focus:text-muhammadiyah-500 transition-all duration-300 peer-focus:-translate-y-1 peer-focus:text-xs peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-placeholder-shown:top-4">
                        <div class="flex items-center">
