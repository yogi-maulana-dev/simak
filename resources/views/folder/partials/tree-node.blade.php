...
<li>
    <a
        href="{{ route('arsip.show', $rootUuid) }}?sub={{ $folder->id }}"
        ...
        @class([
            ...
            'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700/60 hover:text-gray-800' => $currentId !== $folder->id,
        ])
    >
