                ...
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Reset password untuk: <span class="font-semibold"><?php echo e($user->name); ?></span> (<?php echo e($user->email); ?>)
                        </p>
                    </div>
                    ...
                    <form wire:submit.prevent="resetPassword">
                            ...
                            <div class="flex items-start mb-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                ...
                                <div class="ml-3 flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 mt-1">
                                        Password: <code class="bg-green-100 text-green-800 px-2 py-1 rounded text-xs font-mono"><?php echo e($defaultPassword); ?></code>
                                    </p>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->showCustomFields): ?>
                            <div class="space-y-6 mb-6 p-6 bg-gray-50 border border-gray-200 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['customPassword'];
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 relative">
                                        <input
                                            ...
                                            type="<?php echo e($showPasswordConfirmation ? 'text' : 'password'); ?>"
                                            class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-10"
                                            required
                                        ...
                                        <button type="button"
                                                ...
                                                class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPasswordConfirmation): ?>
                                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.59 6.59m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                                </svg>
                                            <?php else: ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['customPassword_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($customPassword): ?>
                                        <span class="text-sm text-gray-500">
                                            Panjang: <?php echo e(strlen($customPassword)); ?> karakter
                                        </span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                                    ...
                                    <div class="bg-white p-4 rounded-lg border border-gray-200">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <code class="text-lg font-mono text-gray-900 bg-gray-100 px-3 py-2 rounded flex-1 overflow-x-auto">
                                                <?php echo e($customPassword); ?>

                                            </code>
                                            <button
                                                type="button"
                                                onclick="copyToClipboard('<?php echo e($customPassword); ?>')"
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:text-gray-500 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200 active:text-gray-800 active:bg-gray-50 transition ease-in-out duration-150">
                                Batal
                            </a>
                            <button type="submit" 
                                wire:loading.attr="disabled"
                                <?php if($resetType === 'custom' && (!$customPassword || !$customPassword_confirmation)): ?> disabled <?php endif; ?>
                                class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500 active:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 <?php if($resetType === 'custom' && (!$customPassword || !$customPassword_confirmation)): ?> opacity-50 cursor-not-allowed <?php endif; ?>">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/>
                                </svg>
                                Reset Password
...
</div><?php /**PATH /home/bismillah/Dokumen/Project/Folder Baru/simak/resources/views/livewire/admin/reset-password.blade.php ENDPATH**/ ?>