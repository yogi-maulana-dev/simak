...
<div class="bg-white rounded-xl shadow-md p-6 mb-8">
    ...
    <form method="GET" action="<?php echo e(url('/')); ?>" class="flex flex-col md:flex-row gap-4">
        <div class="flex-1 relative">
            ...
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari berdasarkan judul atau deskripsi..." class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent">
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search')): ?>
            <a href="<?php echo e(url('/')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-3 px-6 rounded-lg transition-colors">Reset</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </form>
</div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $arsipPublik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $arsip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-gray-900"><?php echo e($arsip->judul); ?></div>
                            <div class="text-sm text-gray-500 line-clamp-1"><?php echo e($arsip->deskripsi ?: '-'); ?></div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($arsip->created_at->format('Y')); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-500">
                            <?php echo e($arsip->fakultas?->nama_fakultas ?? '-'); ?>

                        </td>
                        <td class="px-6 py-4 text-sm text-gray-500">
                            <?php echo e($arsip->prodi?->nama_prodi ?? '-'); ?>
...
<!-- Pagination Links -->
<div class="mt-6">
    <?php echo e($arsipPublik->appends(['search' => request('search')])->links()); ?>
    ...
    <footer class="bg-primary text-white mt-12">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="border-t border-green-800 mt-8 pt-6 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> Universitas Muhammadiyah Lampung. Hak Cipta Dilindungi. Arsip Akreditasi
                    Resmi.</p>
            </div>
        </div>
    </footer>
