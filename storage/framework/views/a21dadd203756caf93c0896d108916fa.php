                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('login')): ?>
                    <div class="mt-4 md:mt-0 text-right z-10">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="dashboard-button focus:outline focus:outline-2 focus:rounded-sm focus:outline-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="login-button focus:outline focus:outline-2 focus:rounded-sm focus:outline-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="register-button focus:outline focus:outline-2 focus:rounded-sm focus:outline-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="absolute inset-0 flex items-center">
                            <div class="container mx-auto px-8">
                                <div class="max-w-2xl text-white">
                                    ...
                                    <p class="text-lg mb-6">Akses dokumen lengkap akreditasi institusi Universitas Muhammadiyah Lampung, termasuk borang, laporan evaluasi diri, dan sertifikat.</p>
                ...
                <div class="slider-slide">
                    <div class="relative h-64 md:h-80">
                        ...
                        <div class="absolute inset-0 flex items-center">
                            <div class="container mx-auto px-8">
                                <div class="max-w-2xl text-white">
                                    <h2 class="text-3xl md:text-4xl font-bold mb-3">Borang Akreditasi Program Studi</h2>
                                    <p class="text-lg mb-6">Kumpulan borang akreditasi seluruh program studi di lingkungan Universitas Muhammadiyah Lampung.</p>
                        ...
                        <div class="absolute inset-0 flex items-center">
                            <div class="container mx-auto px-8">
                                <div class="max-w-2xl text-white">
                                    ...
                                    <p class="text-lg mb-6">Unduh sertifikat akreditasi institusi dan program studi dengan peringkat Unggul, Baik Sekali, dan Baik.</p>
                        ...
                        <div class="absolute inset-0 flex items-center">
                            <div class="container mx-auto px-8">
                                <div class="max-w-2xl text-white">
                                    ...
                                    <p class="text-lg mb-6">Dokumen lengkap Evaluasi Diri (LED) untuk keperluan akreditasi, sebagai bahan referensi peningkatan mutu.</p>
            ...
            <div class="lg:w-3/4">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        <div class="flex-1 relative">
                            ...
                            <input type="text" placeholder="Cari berdasarkan nama prodi, tahun akreditasi, peringkat..." class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent">
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <!-- Card 1: Borang Akreditasi Prodi Teknik Informatika -->
                        <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover">
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-4">
                                    <span class="bg-green-100 text-secondary text-xs font-medium px-3 py-1 rounded-full">Borang Akreditasi</span>
                                    <span class="text-gray-500 text-sm">2024</span>
                                </div>
                                <h3 class="font-bold text-lg text-gray-800 mb-2">Borang Akreditasi Prodi Teknik Informatika</h3>
                                <p class="text-gray-600 text-sm mb-4">Dokumen lengkap borang akreditasi program studi Teknik Informatika dengan target peringkat Unggul (A).</p>
                        ...
                        <!-- Card 2: Sertifikat Akreditasi Institusi Unggul -->
                        <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover">
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-4">
                                    <span class="bg-green-100 text-secondary text-xs font-medium px-3 py-1 rounded-full">Sertifikat</span>
                                    <span class="text-gray-500 text-sm">2023</span>
                                </div>
                                <h3 class="font-bold text-lg text-gray-800 mb-2">Sertifikat Akreditasi Institusi - Unggul</h3>
                                <p class="text-gray-600 text-sm mb-4">Sertifikat akreditasi institusi Universitas Muhammadiyah Lampung dengan peringkat Unggul, berlaku hingga 2028.</p>
                                <div class="flex justify-between items-center text-sm text-gray-500">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <span>
                                        ...
                                        SK No. 1234/SK/BAN-PT/Ak/PT/2023
                                    </span>
                                </div>
                            </div>
                            <div class="bg-gray-50 px-6 py-3 border-t border-gray-100">
                        ...
                        <!-- Card 3: Laporan Evaluasi Diri Prodi PGSD -->
                        <div class="bg-white rounded-xl shadow-md overflow-hidden card-hover">
                            <div class="p-6">
                                <div class="flex justify-between items-start mb-4">
                                    <span class="bg-green-100 text-secondary text-xs font-medium px-3 py-1 rounded-full">LED</span>
                                    <span class="text-gray-500 text-sm">2024</span>
                                </div>
                                <h3 class="font-bold text-lg text-gray-800 mb-2">LED Prodi PGSD – Reakreditasi 2024</h3>
                                <p class="text-gray-600 text-sm mb-4">Laporan Evaluasi Diri (LED) program studi Pendidikan Guru Sekolah Dasar dalam rangka reakreditasi.</p>
                                <div class="flex justify-between items-center text-sm text-gray-500">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
    ...
    <footer class="bg-primary text-white mt-12">
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-300 mb-4">
                        Sistem arsip digital khusus dokumen akreditasi institusi dan program studi Universitas Muhammadiyah Lampung. Menyediakan borang, sertifikat, LED, dan perangkat akreditasi lainnya.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-300 mb-4">Dapatkan pemberitahuan terbaru tentang dokumen akreditasi dan jadwal reakreditasi.</p>
                    <div class="flex">
            ...
            <div class="border-t border-green-800 mt-8 pt-6 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> Universitas Muhammadiyah Lampung. Hak Cipta Dilindungi. Arsip Akreditasi Resmi.</p>
            </div>
        </div>
    </footer>
...
</html><?php /**PATH /home/bismillah/Dokumen/Project/Folder Baru/simak/resources/views/welcome.blade.php ENDPATH**/ ?>