                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-8">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\Arsip::class)): ?>
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                         <?php if($arsip->fakultas): ?> bg-blue-100 text-blue-800 <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                             <?php echo e($arsip->user->fakultas->nama_fakultas ?? '-'); ?>

                                            </span>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo e($arsip->created_at->format('d/m/Y')); ?>
                                            ...
                                            <div class="text-gray-500">
                                                ...
                                                <p class="mt-3 text-lg font-medium text-gray-900">
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                                                        Tidak ditemukan arsip dengan kata kunci "<?php echo e($search); ?>"
                                                    <?php else: ?>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Apakah Anda yakin ingin menghapus arsip <span class="font-semibold">"<?php echo e($deleteJudul); ?>"</span>?
                                </p>
                                <p class="mt-2 text-sm text-gray-500">
...
</script><?php /**PATH /home/umlacid/simak.uml.ac.id/resources/views/livewire/arsip/index.blade.php ENDPATH**/ ?>